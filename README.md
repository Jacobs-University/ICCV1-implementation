...
This repository is for the course "Data Visualisation and Image Processing" as a final project or paper implementation
...
## What are we addressing and challenges faced during the process?
* we are implementing "Domain adaption Object Detection "on source dataset (KITTI and CITYSCAPE datasets converted to COCO format) using pretrained Faster R-CNN, YOLO
* Due to certain limitation of hardware, we have used pre-trained models along with the weights instead of training our own models.
* The Jupyter Notebooks in this repo has complete working models that predicts 'Object Detection' task for various images, including false labelled /blurry images usinf pre-trained models like Faster-RCNN, YOLO_v2, YOLO_v3, SSD and finally we compare their performances based on visual scanerios. 

### The main challenge we faced was setting up Deepl-Learning environment with CUDA, Caffe, Caffe2 and Pycaffe installation to train our own models but unfortunately. end of the we had to revert back to using available pre-trained models 


# Method _ 1
## Faster RCNN model trained on Pascal VOC dataset with ResNet-50, SSD and YOLO.
